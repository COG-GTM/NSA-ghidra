...

{
  if (ptrto->getMetatype() == TYPE_UNION) {
    ...
    ScoreUnionFields scoreFields(*fd->getArch()->types.get(),this,op,slot);
...

{
  ...
  ResolvedUnion compFill(this,fieldNum,*fd->getArch()->types.get());
...

{
  ...
  if (res != (ResolvedUnion *)0) {
    ...
    ScoreUnionFields scoreFields(*fd->getArch()->types.get(),this,offset,op);
    fd->setUnionField(this, op, slot, scoreFields.getResult());
    ...
    ScoreUnionFields scoreFields(*fd->getArch()->types.get(),this,offset,op,slot);
    fd->setUnionField(this, op, slot, scoreFields.getResult());
    if (scoreFields.getResult().getFieldNum() >= 0) {
