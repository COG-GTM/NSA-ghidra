...
public class DependencyReportTest extends AbstractGenericTest {
	...
	public void testReaderRejectsSchemaDrift() {
		...
		String[] broken = {
			...
			json.replace("\"rule\": \"plaintext_port\"", "\"rule\": \"made_up_rule\""),
			json.replace("\"hostname\": 1", "\"hostname\": 2"),
			json.replace("\"hostname\": 1", "\"host\": 1"),
			json.replace("\"hostname\": 1", "\"hostname\": 1, \"ipv4\": 0"),
			json.replace("\"high\": 1", "\"high\": 2"),
			json.replace("\"resolver\": 1", "\"resolver\": \"1\""),
			json.replace("\"resolver\": 1", "\"resolver\": 1.5"),
			json.replace("\"endpointCount\": 3", "\"endpointCount\": 3.0"),
